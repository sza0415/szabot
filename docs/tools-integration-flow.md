...
- [tool.go](/Users/ziangsun/Documents/szabot/internal/tools/tool.go)
- [workspace.go](/Users/ziangsun/Documents/szabot/internal/tools/workspace.go)
- [read_file.go](/Users/ziangsun/Documents/szabot/internal/tools/read_file.go)
- [write_file.go](/Users/ziangsun/Documents/szabot/internal/tools/write_file.go)
- [edit_file.go](/Users/ziangsun/Documents/szabot/internal/tools/edit_file.go)
- [list_dir.go](/Users/ziangsun/Documents/szabot/internal/tools/list_dir.go)
- [glob.go](/Users/ziangsun/Documents/szabot/internal/tools/glob.go)
- [grep.go](/Users/ziangsun/Documents/szabot/internal/tools/grep.go)
- [sandbox.go](/Users/ziangsun/Documents/szabot/internal/tools/sandbox.go)
- [bash.go](/Users/ziangsun/Documents/szabot/internal/tools/bash.go)
- [python.go](/Users/ziangsun/Documents/szabot/internal/tools/python.go)
...
所有文件类工具都不直接把模型给出的路径交给 `os` 包，而是先经过一层统一的工作区校验。这段逻辑被抽到 [workspace.go](/Users/ziangsun/Documents/szabot/internal/tools/workspace.go)，供所有文件工具复用，把「安全边界」收敛到一处：
...
`bash` 和 `python` 不在宿主机直接执行，而是共用一个 [sandbox.go](/Users/ziangsun/Documents/szabot/internal/tools/sandbox.go) 中的 `Sandbox`，每次执行都起一个一次性容器。
